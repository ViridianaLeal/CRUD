...
resultado.data.forEach(fila=>{
  ...
  <tr>
    ...
    <td>${fila[4]}</td>
    <td>${fila[5]}</td>
    <td><button class="btn btn-success" onclick="editarContacto(${fila[0]})"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
